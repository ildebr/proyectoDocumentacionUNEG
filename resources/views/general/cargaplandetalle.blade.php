            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <label class="mt-6" for="capacidades">Capacidades a desarrollar (tematica)
                        ...
                        <textarea style="display: none"  class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="capacidades" id="capacidades" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6" for="habilidades">Habilidades a desarrollar (tematica)
                        <div id="habilidades-text"></div>
                        <textarea style="display: none" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="habilidades" id="habilidades" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6" for="capacidades_profesionales_tematica">Capacidades profesionales (tematica)
                        ...
                        <textarea style="display: none" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="capacidades_profesionales_tematica" id="capacidades_profesionales_tematica" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6" for="red_tematica">Red tematica (tematica)
                        <div id="red_tematica-text"></div>
                        <textarea style="display: none" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="red_tematica" id="red_tematica" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6" for="descripcion_red_tematica">Descripcion de la red tematica (tematica)
                        <textarea  class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="descripcion_red_tematica" id="descripcion_red_tematica" cols="30" rows="10"></textarea>
                    </label>
                    ...
                    <label class="mt-6 block" for="comp_profesionales_basicas">Competencias Profesionales Basicas
                        <textarea  class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="comp_profesionales_basicas" id="comp_profesionales_basicas" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6 block" for="comp_profesionales_especificas">Competencias Profesionales Especificas
                        <textarea  class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="comp_profesionales_especificas" id="comp_profesionales_especificas" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6 block" for="comp_unidad_curricular">Competencias de la Unidad Curricular
                        <textarea  class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="comp_unidad_curricular" id="comp_unidad_curricular" cols="30" rows="10"></textarea>
                    </label>
                    ...
                    <label class="mt-6 block" for="valores_actitudes">Valores y actitudes
                        ...
                        <textarea style="display: none" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="valores_actitudes" id="valores_actitudes" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6 block" for="estrategias_didacticas">Estrategias Didacticas
                        <textarea  class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="estrategias_didacticas" id="estrategias_didacticas" cols="30" rows="10"></textarea>
                    </label>
                    <label class="mt-6 block" for="estrategias_docentes">Estrategias Docentes
                        <div id="estrategias_docentes-text"></div>
                        <textarea style="display: none" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-2 w-full" name="estrategias_docentes" id="estrategias_docentes" cols="30" rows="10"></textarea>
                    </label>
